...
const (
	defaultShardADSN = "clickhouse://clickhouse:clickhouse@localhost:56431/default?dial_timeout=5s"
	defaultShardBDSN = "clickhouse://clickhouse:clickhouse@localhost:56432/default?dial_timeout=5s"
...
func openShard(ctx context.Context, id shard.ID, dsn string) (*xch.Pool, error) {
	options := []xch.Option{
